-- CreateEnum
CREATE TYPE "UserGoal" AS ENUM ('ORGANIZE', 'SAVE', 'GET_OUT_DEBT');

-- CreateEnum
CREATE TYPE "InsightType" AS ENUM ('SPENDING_SPIKE', 'CATEGORY_OVERUSE', 'BUDGET_EXCEEDED', 'POSITIVE_FEEDBACK');
